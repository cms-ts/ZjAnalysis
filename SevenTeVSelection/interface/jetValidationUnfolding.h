#ifndef jetValidationUnfolding_h
#define jetValidationUnfolding_h
...
#include "ZjAnalysis/SevenTeVTools/interface/TemplateForHistogramsUnfolding.h" // skeleton to clone the histograms
...
class jetValidationUnfolding : public edm::EDAnalyzer {
   public:
      explicit jetValidationUnfolding(const edm::ParameterSet&);
      ~jetValidationUnfolding();
...
//EB ========================================================================
  h_jetPt_EB = fs->make<TH1F>("h_jetPt_EB","jetPt_EB",divPlot_leading2,minPtPlot_leading2,maxPtPlot_leading2);
  h_jetEta_EB = fs->make<TH1F>("h_jetEta_EB","jetEta_EB",100,-2.5,2.5);
  h_jetNum_EB = fs->make<TH1F>("h_jetNum_EB","jetNum_EB",10,minPtPlot_leading2,10);
  h_jetPtFirst_EB = fs->make<TH1F>("h_jetPtFirst_EB","jetPtFirst in EB",divPlot_leading2,minPtPlot_leading2,maxPtPlot_leading2);
  h_jetPtSecond_EB = fs->make<TH1F>("h_jetPtSecond_EB","jetPtSecond in EB",divPlot_subleading2,minPtPlot_subleading2,maxPtPlot_subleading2);
  h_jetPtThird_EB = fs->make<TH1F>("h_jetPtThird_EB","jetPtThird in EB",divPlot_subsubleading2,minPtPlot_subsubleading2,maxPtPlot_subsubleading2);
  h_jetPtFourth_EB = fs->make<TH1F>("h_jetPtFourth_EB","jetPtFourth in EB",divPlot_subsubsubleading2,minPtPlot_subsubsubleading2,maxPtPlot_subsubsubleading2);
  h_jetPtFirstCk_EB = fs->make<TH1F>("h_jetPtFirstCk_EB","jetPt of the absolute first jet - EB",divPlot_leading2,minPtPlot_leading2,maxPtPlot_leading2);
  h_jetPtSecondCk_EB = fs->make<TH1F>("h_jetPtSecondCk_EB","jetPt of the absolute second jet - EB",divPlot_subleading2,minPtPlot_subleading2,maxPtPlot_subleading2);
  h_jetPtThirdCk_EB = fs->make<TH1F>("h_jetPtThirdCk_EB","jetPt of the absolute third jet - EB",divPlot_subsubleading2,minPtPlot_subsubleading2,maxPtPlot_subsubleading2);
  h_jetPtFourthCk_EB = fs->make<TH1F>("h_jetPtFourthCk_EB","jetPt of the absolute fourth jet - EB",divPlot_subsubsubleading2,minPtPlot_subsubsubleading2,maxPtPlot_subsubsubleading2);
  h_jetPtVsEta_EB = fs->make<TH2F>("h_jetPtVsEta_EB","jetPtVsEta_EB",100,-2.5,2.5,divPlot_leading2,minPtPlot_leading2,maxPtPlot_leading2);
  h_jetPtNjet1_EB = fs->make<TH1F>("h_jetPtNjet1_EB","jetPtNjet1_EB",divPlot_leading2,minPtPlot_leading2,maxPtPlot_leading2);
  h_jetPtNjet2_EB = fs->make<TH1F>("h_jetPtNjet2_EB","jetPtNjet2_EB",divPlot_subleading2,minPtPlot_subleading2,maxPtPlot_subleading2);
  h_jetPtNjet3_EB = fs->make<TH1F>("h_jetPtNjet3_EB","jetPtNjet3_EB",divPlot_subsubleading2,minPtPlot_subsubleading2,maxPtPlot_subsubleading2);
  h_jetPtNjet4_EB = fs->make<TH1F>("h_jetPtNjet4_EB","jetPtNjet4_EB",divPlot_subsubsubleading2,minPtPlot_subsubsubleading2,maxPtPlot_subsubsubleading2);
  h_massMinusPdgGsf_EB = fs->make<TH1F>("h_massMinusPdgGsf_EB","massMinusPdgGsf_EB",100,-50,50);
//EE ========================================================================
  h_jetPt_EE = fs->make<TH1F>("h_jetPt_EE","jetPt_EE",divPlot_leading2,minPtPlot_leading2,maxPtPlot_leading2);
  h_jetEta_EE = fs->make<TH1F>("h_jetEta_EE","jetEta_EE",100,-2.5,2.5);
  h_jetNum_EE = fs->make<TH1F>("h_jetNum_EE","jetNum_EE",10,0.,10);
  h_jetPtFirst_EE = fs->make<TH1F>("h_jetPtFirst_EE","jetPtFirst in EE",divPlot_leading2,minPtPlot_leading2,maxPtPlot_leading2);
  h_jetPtSecond_EE = fs->make<TH1F>("h_jetPtSecond_EE","jetPtSecond in EE",divPlot_subleading2,minPtPlot_subleading2,maxPtPlot_subleading2);
  h_jetPtThird_EE = fs->make<TH1F>("h_jetPtThird_EE","jetPtThird in EE",divPlot_subsubleading2,minPtPlot_subsubleading2,maxPtPlot_subsubleading2);
  h_jetPtFourth_EE = fs->make<TH1F>("h_jetPtFourth_EE","jetPtFourth in EE",divPlot_subsubsubleading2,minPtPlot_subsubsubleading2,maxPtPlot_subsubsubleading2);
  h_jetPtFirstCk_EE = fs->make<TH1F>("h_jetPtFirstCk_EE","jetPt of the absolute first jet - EE",divPlot_leading2,minPtPlot_leading2,maxPtPlot_leading2);
  h_jetPtSecondCk_EE = fs->make<TH1F>("h_jetPtSecondCk_EE","jetPt of the absolute second jet - EE",divPlot_subleading2,minPtPlot_subleading2,maxPtPlot_subleading2);
  h_jetPtThirdCk_EE = fs->make<TH1F>("h_jetPtThirdCk_EE","jetPt of the absolute third jet - EE",divPlot_subsubleading2,minPtPlot_subsubleading2,maxPtPlot_subsubleading2);
  h_jetPtFourthCk_EE = fs->make<TH1F>("h_jetPtFourthCk_EE","jetPt of the absolute fourth jet - EE",divPlot_subsubsubleading2,minPtPlot_subsubsubleading2,maxPtPlot_subsubsubleading2);
  h_jetPtVsEta_EE = fs->make<TH2F>("h_jetPtVsEta_EE","jetPtVsEta_EE",100,-2.5,2.5,divPlot_leading2,minPtPlot_leading2,maxPtPlot_leading2);
  h_jetPtNjet1_EE = fs->make<TH1F>("h_jetPtNjet1_EE","jetPtNjet1_EE",divPlot_leading2,minPtPlot_leading2,maxPtPlot_leading2);
  h_jetPtNjet2_EE = fs->make<TH1F>("h_jetPtNjet2_EE","jetPtNjet2_EE",divPlot_subleading2,minPtPlot_subleading2,maxPtPlot_subleading2);
  h_jetPtNjet3_EE = fs->make<TH1F>("h_jetPtNjet3_EE","jetPtNjet3_EE",divPlot_subsubleading2,minPtPlot_subsubleading2,maxPtPlot_subsubleading2);
  h_jetPtNjet4_EE = fs->make<TH1F>("h_jetPtNjet4_EE","jetPtNjet4_EE",divPlot_subsubsubleading2,minPtPlot_subsubsubleading2,maxPtPlot_subsubsubleading2);
...
// histo about what there is around the electrons
  ...
  h_jetEtaNjet1 = fs->make<TH1F>("h_jetEtaNjet1","jetEtaNjet1",divPlot_leading2eta,minEtaPlot_leading2,maxEtaPlot_leading2);
  h_jetEtaNjet2 = fs->make<TH1F>("h_jetEtaNjet2","jetEtaNjet2",divPlot_subleading2eta,minEtaPlot_subleading2,maxEtaPlot_subleading2);
  h_jetEtaNjet3 = fs->make<TH1F>("h_jetEtaNjet3","jetEtaNjet3",divPlot_subsubleading2eta,minEtaPlot_subsubleading2,maxEtaPlot_subsubleading2);
  h_jetEtaNjet4 = fs->make<TH1F>("h_jetEtaNjet4","jetEtaNjet4",divPlot_subsubsubleading2eta,minEtaPlot_subsubsubleading2,maxEtaPlot_subsubsubleading2);
  h_jetEtaNjet1Incl = fs->make<TH1F>("h_jetEtaNjet1Incl","jetEtaNjet1Incl",divPlot_leading2eta,minEtaPlot_leading2,maxEtaPlot_leading2);
  h_jetEtaNjet2Incl = fs->make<TH1F>("h_jetEtaNjet2Incl","jetEtaNjet2Incl",divPlot_subleading2eta,minEtaPlot_subleading2,maxEtaPlot_subleading2);
  h_jetEtaNjet3Incl = fs->make<TH1F>("h_jetEtaNjet3Incl","jetEtaNjet3Incl",divPlot_subsubleading2eta,minEtaPlot_subsubleading2,maxEtaPlot_subsubleading2);
  h_jetEtaNjet4Incl = fs->make<TH1F>("h_jetEtaNjet4Incl","jetEtaNjet4Incl",divPlot_subsubsubleading2eta,minEtaPlot_subsubsubleading2,maxEtaPlot_subsubsubleading2);

  h_jetHtNjet1 = fs->make<TH1F>("h_jetHtNjet1","jetHtNjet1",divHtPlot_leading2,minHtPlot_leading2,maxHtPlot_leading2);
  h_jetHtNjet2 = fs->make<TH1F>("h_jetHtNjet2","jetHtNjet2",divHtPlot_subleading2,minHtPlot_subleading2,maxHtPlot_subleading2);
  h_jetHtNjet3 = fs->make<TH1F>("h_jetHtNjet3","jetHtNjet3",divHtPlot_subsubleading2,minHtPlot_subsubleading2,maxHtPlot_subsubleading2);
  h_jetHtNjet4 = fs->make<TH1F>("h_jetHtNjet4","jetHtNjet4",divHtPlot_subsubsubleading2,minHtPlot_subsubsubleading2,maxHtPlot_subsubsubleading2);
...
jetValidationUnfolding::~jetValidationUnfolding()
{
