...
#"file:/gpfs/grid/srm/cms/store/data/Run2011A/DoubleElectron/RAW-RECO/ZElectron-08Nov2011-v1/0000/9213ACEA-B01B-E111-9BD9-002618943833.root"
    "file:/gpfs/grid/srm/cms/store/data/Fall11/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola/AODSIM/PU_S6-START44_V5-v1/0001/FEF039CA-2E0A-E111-A2F2-485B39800BD7.root"
...
#from ZjAnalysis.SevenTeVSelection.jecChsConfig_cfi import *
...
####
###################
from ZjAnalysis.SevenTeVSelection.PFJetParametersRC_cfi import *
...
###  JETS without muons
####
process.ak5PFJetsRCmu = process.ak5PFJetsRC.clone(src = 'pfNoMuon')
process.ak5PFJetsRCmuL2L3 = process.ak5PFJetsL2L3.clone(src = 'ak5PFJetsRCmu')
process.ak5PFchsJetsRCmuL1FastL2L3 = process.ak5PFJetsL1FastL2L3.clone(src = 'ak5PFJetsRCmu', correctors = ['ak5PFchsL1FastL2L3'])

####
###  JETS without pile-up
####
...
process.validationJEC = cms.EDAnalyzer('jetValidationUnfolding',
                                       ...
                                       genJets = cms.InputTag("ak5GenJetsENoGammaCone"),
...
process.validationOldJEC = process.validationJEC.clone(
                                       jetCollection = "ak5PFJetsL1FastL2L3",
                                       deltaRConeJet = 0.3,
                                       deltaRCone    = 0.3,
                                       RootuplaName  = "treeOLDJEC_"                                                
                                       )

process.validationTESTJEC = process.validationJEC.clone(
                                       jetCollection = "ak5PFJetsOLDL1FastL2L3",
                                       deltaRConeJet = 0.3,
                                       deltaRCone    = 0.3,
                                       RootuplaName  = "treeTESTJEC_"                                                
                                       )

process.validationL2L3 = process.validationJEC.clone(
                                       jetCollection = "ak5PFJetsL2L3",
                                       deltaRConeJet = 0.3,
                                       deltaRCone    = 0.3,
                                       RootuplaName  = "treeL2L3_"                                                
                                       )

process.validationJECmu = process.validationJEC.clone(
...
process.validationJECXSScaleUp = process.validationJEC.clone(
                                       WeightName   = 'EventWeightScaleUp',
                                       RootuplaName = "treeXSScaleUp_"
                                       )

process.validationJECMuXSScaleUp = process.validationJECXSScaleUp.clone(
                                       jetCollection = "ak5PFchsJetsRCmuL1FastL2L3",
                                       goodEPair = "goodMuPair",
                                       genJets = "ak5GenJetsMuNoGammaCone",
                                       RootuplaName = "treeXSScaleUpMu_",
                                       isElectron = False
                                       )

process.validationJECXSScaleDown = process.validationJEC.clone(
                                       WeightName   = 'EventWeightScaleDown',
                                       RootuplaName = "treeXSScaleDown_"
                                       )

process.validationJECMuXSScaleDown = process.validationJECXSScaleDown.clone(
                                       jetCollection = "ak5PFchsJetsRCmuL1FastL2L3",
                                       goodEPair = "goodMuPair",
                                       genJets = "ak5GenJetsMuNoGammaCone",
                                       RootuplaName = "treeXSScaleDownMu_",
                                       isElectron = False
                                       )
...
process.SelectionMu = cms.EDFilter('ZpatFilterMu2011Unfolding',
                                   muonCollection = cms.InputTag('matchedMuons'),
                                   lowZmassLimit  = cms.double(71.0),
                                   highZmassLimit = cms.double(111.0)
                                   )

process.Selection = cms.EDFilter('ZpatFilter2011Unfolding',
...
process.goodMuPair = process.goodEPair.clone(isElectron = False)
...
GenJetParameters = cms.PSet(
    src            = cms.InputTag("genParticlesForJetsENoNuNoGammaCone"),
    srcPVs         = cms.InputTag(''),
...
process.ak5GenJetsENoGammaCone = cms.EDProducer(
    "FastjetJetProducer",
     GenJetParameters,
    AnomalousCellParameters,
    jetAlgorithm = cms.string("AntiKt"),
