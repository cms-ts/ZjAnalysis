...
#include "lumi_scale_factorsARC.h"
...
string version="_v2_58.root";  // which version you wonna analize
string versionPath="_v2_58";

string plotpathEle		="plotEleXScale"+versionPath+"/";
string plotpathMu		="plotMuXScale"+versionPath+"/";
string plotpath;

//string plotpath		="plotMuXScale_v2_30/";
...
void DrawComparisonJetMCDataXScale(void){
  struct STestFunctor {
