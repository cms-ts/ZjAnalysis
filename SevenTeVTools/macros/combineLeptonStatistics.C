...
int combineLeptonStatistics () {
  ...
  elePathFile="/gpfs/cms/data/2011/Unfolding/UnfoldingOfficialV58_BinWidth.root";
  muoPathFile="/gpfs/cms/data/2011/Unfolding/UnfoldingOfficialV58_BinWidthMu.root";

  TFile output_file("/gpfs/cms/data/2011/Unfolding/UnfoldingOfficialV58_BinWidthCombined.root","RECREATE");
